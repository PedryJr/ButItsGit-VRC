Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro Outline/81ffa0a6bc2b4434f8bda014fe6d0602"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				poiFragData.baseColor *= float4(poiThemeColor(poiMods, float4(0.3712378,0.3915726,0.6307573,1).rgb, (0.0 /*_LineColorThemeIndex*/)), float4(0.3712378,0.3915726,0.6307573,1).a);
				if ((1.0 /*_OutlineExpansionMode*/) == 2)
				{
