Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro Outline/1564a5857499e9b419d177d63b16fa24"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				poiFragData.baseColor *= float4(poiThemeColor(poiMods, float4(0.3712378,0.3915726,0.6307572,1).rgb, (0.0 /*_LineColorThemeIndex*/)), float4(0.3712378,0.3915726,0.6307572,1).a);
				if ((1.0 /*_OutlineExpansionMode*/) == 2)
				{
